        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SoldProductsProductID = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_InvoiceProduct", x => new { x.InvoicesInvoiceID, x.SoldProductsProductID });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_InvoiceProduct_Products_SoldProductsProductID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InvoiceProduct_SoldProductsProductID",
